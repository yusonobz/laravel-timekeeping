  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['method'=> 'PATCH','url'=>'/purpleBugTK']) !!}
   ...
   {!! Form::label('time_out','To:') !!}
	...
	<div class="container">
		<div class="row">
					 ...
					 <a class="btn btn-default"href="{{ url('/generateReport') }}" style="float:left;" id="#squarespaceModal"><i class="fa fa-calendar-o obj-color"></i> View Attendances</a>
    ...
    <tbody>
					  <tbody>
					  	...
					  	@if(\Carbon\Carbon::today()->toDateString() == $att->date && Auth::user()->id == $att->emp_id)
						<tr>
